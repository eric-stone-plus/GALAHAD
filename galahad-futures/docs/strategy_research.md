# GALAHAD Futures — strategy research (private)

**2026-08-05.** Complements public `GALAHAD/docs/strategy_foundations.md`.

## Canon used (local host Firecrawl + arXiv API)

Scraped successfully on `127.0.0.1:3002` (no cloud credits):
...
Validation doctrine (DSR/PBO/purged CV) already in `quantkit.validation` and
`docs/library_digest/finance_validation_overfitting.md` (Huatai AI series + AFML).
...
```bash
cd ~/Documents/Private/quant-analysis/futures
