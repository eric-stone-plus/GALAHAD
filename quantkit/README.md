...
score = keyword_sentiment("利好上涨超预期")
```
...
**Finding**: A-share震荡市中，factor tilt beats pure momentum. 动量信号在震荡市追涨杀跌。
...
**Finding**: US成长股中momentum有效，但需要风险控制（conformal weight policy）。
