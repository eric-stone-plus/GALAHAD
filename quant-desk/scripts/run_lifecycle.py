#!/usr/bin/env python3
"""Historical lifecycle: select → rebalance → mark-to-market at the rebalance frequency, then evaluate + review HTML.
...
def main() -> int:
    ...
    p = argparse.ArgumentParser(description="quant_desk historical lifecycle")
    ...
    print(f"Downloading universe of {len(universe)} names …")
